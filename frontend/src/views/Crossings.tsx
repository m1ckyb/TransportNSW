  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const needsFastPolling = trackData.some(t => {
        ...
        const isCriticalDown = ['665', '667', '647', '645', '660', '653', '658', '651', '628', '626', '624', '622', '621', '619'].some(s => matchesSection(section, s));
        const isCriticalUp = ['621', '619', '622', '624', '626', '628', '645', '647', '665', '667', '660', '653', '658', '651'].some(s => matchesSection(section, s));
